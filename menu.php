<ul id="css3menu1" class="topmenu">
   ...
   <!-- <li><a href="inicio.php?btn=garcon"><img src="imagens/money.png" width="40" alt=""/>Vendas</a></li> -->
    ...
    <li><a href="inicio.php?btn=relatoriocliente">Relatório Clientes</a></li>

    <li><a href="inicio.php?btn=relatorioproduto">Relatório Por Produto</a></li>
    ...
    <li><a href="inicio2.php?btn=whatsapp"><img src="imagens/whatsapp.jpg" width="40" alt=""/>Whatsapp</a></li>
    <!--<li><a href="backup/backup.php"><img src="imagens/Burn 3.png" width="40" alt=""/>Backup</a></li>-->
    <!--<li><a href="inicio2.php?btn=entrega"><img src="imagens/Burn 3.png" width="40" alt=""/>A Receber</a></li>-->
	<li><a href="inicio2.php?btn=entrega"><img src="imagens/restaurant.png" width="40" alt=""/>Entrega</a></li>
    <!-- <li><a href="backup/backup.php"><img src="imagens/Burn 2.png" width="40" alt=""/>Backup</a></li> -->
