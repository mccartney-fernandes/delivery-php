...
<div id="box">
  ...
  <td align="center" style="font-size:16px;"><strong>Cliente : <?php echo $row_Recordset1['nome']; ?></strong></td>
  </tr>
  <tr>
	<td align="center" style="font-size:16px;">Rua:<?php echo $row_Recordset1['rua']; ?>&nbsp-&nbsp;Nº <?php echo $row_Recordset1['numerocasa']; ?></td>
</tr>
<tr>
	<td align="center" style="font-size:16px;">Cidade:<?php echo $row_Recordset1['detalhes']; ?></td>
</tr>
<tr>
	<td align="center" style="font-size:16px;">Telefone:<?php echo $row_Recordset1['telefone']; ?></td>
</tr>
...
function Cozinha(pagina,nome,w,h,scroll){
    ...
    <a href="cozinha2.php?id_mesa=<?php echo $id_mesa ?>&nome=<?php echo $nome; ?>"  title="Imprimir"
